            ...
            <div class="flex items-center">
                <div class="leading-loose">
                    <form id="form" action="/cart/finishPayment" method="POST" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
                        ...
                        <div class="mt-4">
                            <button id="pay_button" onclick="connectSocket()"  class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded">{{\Gloudemans\Shoppingcart\Facades\Cart::total()}}€</button>
                        </div>
                    </form>
                </div>
            </div>
